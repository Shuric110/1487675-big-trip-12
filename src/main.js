...
const createDayListTemplate = function () {
  return `
    <ul class="trip-days">
    </ul>
  `;
...
const createDayTemplate = function () {
  return `
...
const createEventTemplate = function () {
  return `
...
const createEventEditorTemplate = function () {
  return `
    <li class="trip-events__item">
...
renderTemplate(tripEventsElement, `beforeend`, createDayListTemplate());

const dayListElement = tripEventsElement.querySelector(`.trip-days`);
renderTemplate(dayListElement, `beforeend`, createDayTemplate());
